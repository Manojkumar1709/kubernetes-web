...
{cmd:"--client-certificate='':", desc:'Path to a client certificate file for TLS'},
    ...
    {cmd:'--insecure-skip-tls-verify=true:', desc:"If true, the server's certificate will not be checked for validity. This will make your HTTPS connections insecure"},
    ...
    {cmd:"--token='':", desc:'Bearer token for authentication to the API server'}, // Fixed: Removed hard-coded token
